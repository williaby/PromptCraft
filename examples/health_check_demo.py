...
def demonstrate_configuration_status() -> None:
    ...
    try:
        ...
        table = Table(
            title="Configuration Status", show_header=True, header_style="bold magenta",
        )
        ...
        table.add_row(
            "Environment", status.environment, "Current deployment environment",
        )
        ...
        table.add_row(
            "Config Source", status.config_source, "Primary configuration source",
        )
        table.add_row(
            "Validation Status",
        ...
        table.add_row(
            "Overall Healthy", str(status.config_healthy), "Computed health status",
        )
