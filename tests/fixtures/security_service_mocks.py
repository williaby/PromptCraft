...
@pytest.fixture
def mock_security_monitor(mock_security_logger, mock_alert_engine):
    """Provide a mock SecurityMonitor."""
    return MockSecurityMonitor(security_logger=mock_security_logger, alert_engine=mock_alert_engine)
