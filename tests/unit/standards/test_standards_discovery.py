...
class TestStandardsDiscoverySystem:
    ...
    def test_discover_standard_with_search_error(self, discovery_system):
        ...
        with patch.object(discovery_system, "_search_project_standards", side_effect=Exception("Project search failed")):
            with patch.object(discovery_system, "_search_user_standards", return_value=mock_standard):
                with patch.object(discovery_system, "_search_default_standards", return_value=None):
                    result = discovery_system.discover_standard("test-standard")
...
class TestStandardsManager:
    ...
    def test_get_linting_standard(self, standards_manager):
        ...
        with patch.object(standards_manager.discovery_system, "get_standard_content", return_value="# Linting Standard"):
    ...
    def test_get_security_standard(self, standards_manager):
        ...
        with patch.object(standards_manager.discovery_system, "get_standard_content", return_value="# Security Standard"):
...
"""
        ...
        def mock_exists(self):
            path_str = str(self)
            return (path_str == str(manager.discovery_system.project_standards_path) or
                    path_str == str(manager.discovery_system.user_standards_path) or
                    path_str == str(project_linting_file) or
                    path_str == str(user_python_file))
