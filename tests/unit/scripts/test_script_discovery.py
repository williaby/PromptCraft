...
class TestScriptsDiscoverySystem:
    ...
    def test_search_project_scripts_exact_filename(self, discovery_system):
        ...
        def mock_exists(self):
            ...
            return (path_str == str(discovery_system.project_scripts_path) or
                    path_str == str(discovery_system.project_scripts_path / "test-script"))
...
""",
    ...
    def test_get_discovery_status(self, discovery_system):
        ...
        with patch("pathlib.Path.exists", return_value=True):
            with patch.object(discovery_system, "get_available_scripts", return_value=["project-script", "user-script"]):
...
class TestScriptsManager:
    ...
    def test_execute_script_not_found(self, scripts_manager):
        ...
        with patch.object(scripts_manager.discovery_system, "get_script", return_value=None):
            with patch.object(scripts_manager.discovery_system, "get_available_scripts", return_value=["script1", "script2"]):
...
"""
        ...
        def mock_exists(self):
            path_str = str(self)
            return (path_str == str(manager.discovery_system.project_scripts_path) or
                    path_str == str(manager.discovery_system.user_scripts_path) or
                    path_str == str(project_setup_file) or
                    path_str == str(user_validate_file))
