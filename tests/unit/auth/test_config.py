...
class TestAuthenticationConfigValidators:
    ...
    def test_validate_jwks_url_explicit_value(self):
        ...
        config = AuthenticationConfig(
            cloudflare_team_domain="myteam",
            cloudflare_jwks_url=explicit_url
        )
...
class TestAuthenticationConfigMethods:
    ...
    def test_is_admin_email_exact_match(self):
        ...
        config = AuthenticationConfig(
            admin_emails=["admin@company.com", "super@test.org"]
        )
    ...
    def test_is_admin_email_domain_match(self):
        ...
        config = AuthenticationConfig(
            admin_email_domains=["company.com", "admin.org"]
        )
...
class TestAuthenticationConfigEdgeCases:
    ...
    def test_config_field_access(self):
        ...
        field_names = [
            "cloudflare_access_enabled", "cloudflare_team_domain", "cloudflare_jwks_url",
            "cloudflare_audience", "cloudflare_issuer", "jwt_algorithm", "jwt_leeway",
            "jwks_cache_ttl", "jwks_cache_max_size", "jwks_timeout", "email_whitelist",
            "email_whitelist_enabled", "admin_emails", "admin_email_domains",
            "rate_limiting_enabled", "rate_limit_requests", "rate_limit_window",
            "rate_limit_key_func", "session_cookie_name", "session_cookie_secure",
            "session_cookie_httponly", "session_cookie_samesite", "auth_error_detail_enabled",
            "auth_logging_enabled", "auth_metrics_enabled"
        ]
