...
from src.auth.services.mock_data_service import MockDataService, DataGenerationMode
...
class TestUserActivityGeneration:
    ...
    async def test_generate_user_activity_data_default_params(self, service):
        ...
        assert all(isinstance(user_id, str) for user_id in user_activities.keys())
        
        # Check user data structure
        user_id = list(user_activities.keys())[0]
