...
class TestWorkflowExecution:
    ...
    async def test_execute_context7_search_workflow_success(self, orchestrator):
        ...
        with patch.object(orchestrator, "discover_and_connect", return_value=True):
            ...
            orchestrator.context7_integration.context7_client.search_documents = AsyncMock(return_value=mock_search_result)
...
class TestConvenienceMethods:
    ...
    async def test_search_documents(self, orchestrator):
        ...
        with patch.object(orchestrator, "execute_workflow") as mock_execute:
            ...
            mock_execute.assert_called_once_with("document_search", {
                "query": "test query",
                "limit": 15,
                "use_context7": True,
            })
    ...
    async def test_execute_tool(self, orchestrator):
        ...
        with patch.object(orchestrator, "execute_workflow") as mock_execute:
            ...
            assert result == mock_result
            mock_execute.assert_called_once_with("tool_execution", {
                "tool_name": "test_tool",
                "arguments": {"arg": "value"},
                "server_name": "server",
            })
    ...
    async def test_context7_search(self, orchestrator):
        ...
        with patch.object(orchestrator, "execute_workflow") as mock_execute:
            ...
            assert result == mock_result
            mock_execute.assert_called_once_with("context7_search", {
                "query": "test query",
                "limit": 20,
            })
...
class TestIntegrationScenarios:
    ...
    async def test_workflow_document_search_integration(self, orchestrator):
        ...
        # Execute workflow
        result = await orchestrator.execute_workflow("document_search", {
    ...
    async def test_workflow_tool_execution_integration(self, orchestrator):
        ...
        result = await orchestrator.execute_workflow("tool_execution", {
            "tool_name": "read_file",
