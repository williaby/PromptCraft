...
class TestAbstractVectorStore:
    ...
    def test_init_abstract_store(self):
        ...
        class TestVectorStore(AbstractVectorStore):
            ...
            async def search(self, parameters): pass
            async def insert_documents(self, documents): pass
            async def update_document(self, document): pass
            async def delete_documents(self, document_ids, collection="default"): pass
            async def create_collection(self, collection_name, vector_size=DEFAULT_VECTOR_DIMENSIONS): pass
            async def list_collections(self): pass
            async def get_collection_info(self, collection_name): pass
