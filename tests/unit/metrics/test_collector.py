...
class TestMetricsCollectorGlobalInstance:
    ...
    def setup_method(self):
        ...
        collector_module._collector_ref[0] = None
    ...
    async def test_get_metrics_collector_creates_instance(self):
        ...
        with patch("src.metrics.collector.MetricsCollector") as mock_collector_cls:
    ...
    async def test_shutdown_metrics_collector(self):
        ...
        with patch("src.metrics.collector.MetricsCollector") as mock_collector_cls:
            ...
            assert collector_module._collector_ref[0] is None
