...
from tests.fixtures import test_authenticated_user
...
class TestDynamicLoadingEndpointsIntegration(FullIntegrationTestBase):
    ...
    def test_performance_monitoring_endpoint(self, client):
        ...
        if response.status_code == 200:
            ...
            possible_fields = [
                "cpu_usage", "memory_usage", "response_times", "throughput",
                "active_connections", "cache_hits", "error_rates"
            ]
    ...
    def test_integration_metrics_endpoint(self, client):
        ...
        if response.status_code == 200:
            ...
            possible_fields = [
                ...
                "error_count", "active_functions", "loading_statistics"
            ]
