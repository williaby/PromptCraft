...
This document serves as the knowledge base for the TestEngineeringAgent, providing it with detailed information
about testing practices, tools, and workflows in the PromptCraft-Hybrid project.

## Agent Overview

The TestEngineeringAgent is a specialized AI agent designed to assist developers with all aspects of software
testing in the PromptCraft codebase. It provides capabilities for:
