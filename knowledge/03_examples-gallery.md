...
## 1. Why Examples Matter: The Power of Few-Shot Prompting
...
## 4. Illustrative Examples of How to Construct In-Prompt Examples
...
#### The LLM would then generate the RFC-style output for the second input
