...
## 1. The Standard Built-in Evaluation Protocol (ANCHOR-QR-8)
...
### # 1.2.3. E.3 Chain-of-Verification (CoVe)
...
## # 1.3. The Standard Evaluation Footer (User Interaction)
...
### # 2.2.1. Enhanced Reflection Loop Controls (ANCHOR-QR-11 #1)
