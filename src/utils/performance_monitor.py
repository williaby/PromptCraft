...
class SLAMonitor:
    ...
    def __init__(self, sla_targets: Optional[Dict[str, float]] = None):
    ...
    def get_violations(self, since: Optional[float] = None) -> List[Dict[str, Any]]:
        """Get SLA violations.
...
def track_performance(operation_name: str, labels: Optional[Dict[str, str]] = None) -> PerformanceTracker:
