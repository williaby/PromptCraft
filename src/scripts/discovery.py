...
class ScriptsDiscoverySystem(LoggerMixin):
    ...
    def __init__(self, project_root: Path | None = None) -> None:
        ...
        self.logger.info(f"Scripts discovery initialized - Project: {self.project_scripts_path}, User: {self.user_scripts_path}")
    ...
    def get_scripts_by_category(self, category: str) -> list[ScriptDefinition]:
        ...
        for script in self._scripts_cache.values():
            if (script.category == category or 
                any(keyword in script.script_id.lower() for keyword in category_keywords)):
    ...
    def search_scripts(self, query: str) -> list[ScriptDefinition]:
        ...
        for script in self._scripts_cache.values():
            if (query in script.script_id.lower() or 
                query in script.name.lower() or 
    ...
    def get_discovery_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "cache_age_seconds": (
                (utc_now() - self._cache_timestamp).total_seconds() 
...
class ScriptsManager(LoggerMixin):
    ...
    def execute_script(self, script_id: str, parameters: list[str] | None = None, dry_run: bool = True) -> dict[str, Any]:
