...
class MCPConnectionBridge(LoggerMixin):
        ...
        try:
            ...
            client = ZenMCPStdioClient(
                ...
                fallback_config=FallbackConfig(
                    enabled=True,
                    base_url="http://localhost:8000",  # Fallback to default
                    timeout=30.0,
                ),
            )
    ...
    async def _is_connection_healthy(self, active_conn: ActiveConnection) -> bool:
        ...
        if (active_conn.last_health_check and 
            utc_now() - active_conn.last_health_check < self.health_check_interval):
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            healthy_connections = sum(
                1 for conn_info in status["connections"].values() 
