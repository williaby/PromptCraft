...
async def get_sla_violations(
    since: Optional[float] = Query(None, description="Unix timestamp to filter violations since")
...
@router.post(
    ...
    summary="Clear SLA violations",
    description="Clear all recorded SLA violations"
)
