...
async def create_service_token(
    ...
    try:
        ...
        # Other errors
        raise HTTPException(status_code=500, detail=f"Failed to create token: {e!s}")
...
async def revoke_service_token(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to revoke token: {e!s}")
...
async def rotate_service_token(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to rotate token: {e!s}")
...
async def list_service_tokens(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list tokens: {e!s}")
...
async def emergency_revoke_all_tokens(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Emergency revocation failed: {e!s}")
