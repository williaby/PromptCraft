...
class IServiceContainer(ABC):
    ...
    @abstractmethod
    def register_transient(self, service_type: Type[T], implementation: Union[Type[T], Callable[..., T], T]) -> None:
...
class ServiceContainer(IServiceContainer):
    ...
    def __init__(self, config: Optional[ServiceContainerConfiguration] = None) -> None:
        ...
        try:
            ...
            if registration.lifetime == ServiceLifetime.SINGLETON:
                if service_type in self._instances:
                    ...
                    elif instance.status == ServiceStatus.ERROR:
    ...
    async def initialize_services(self, service_types: Optional[List[Type]] = None) -> Dict[Type, bool]:
        ...
        try:
            ...
            if inspect.isclass(registration.implementation):
                ...
                if dependencies:
                    ...
                    param_names = [name for name in constructor_params.keys() if name not in ['self', 'cls']]
