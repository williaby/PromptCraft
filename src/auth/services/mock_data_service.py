...
class MockDataService:
    ...
    def __init__(self, mode: DataGenerationMode = DataGenerationMode.REALISTIC):
        ...
        self._event_types = [
            ...
            "data_access", "file_upload", "file_download", "api_request",
            "system_change", "security_alert", "failed_login", "suspicious_activity"
        ]
    ...
    async def generate_user_activity_data(
        ...
        for i in range(user_count):
            ...
            activity_count = random.randint(10, 100) if self.mode == DataGenerationMode.REALISTIC else random.randint(5, 20)
            activities = []
    ...
    def _generate_risk_score(self, event_type: str) -> int:
        ...
        elif event_type in ["permission_change", "system_change"]:
    ...
    def _generate_success_status(self, event_type: str) -> bool:
        ...
        if event_type == "failed_login":
            return False
        elif event_type in ["suspicious_activity", "security_alert"]:
